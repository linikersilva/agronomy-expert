...
public record UpdateClientDto(@Size(max = 50, message = "O tamanho máximo do atributo name é 50 caracteres")
                              String name,
                              @Size(min = 14, max = 14, message = "O tamanho do atributo cpfCnpj deve ser 14 caracteres")
                              String cpfCnpj,
