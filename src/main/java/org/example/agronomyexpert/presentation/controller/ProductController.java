...
public class ProductController {
    ...
    @GetMapping
    public ResponseEntity<Page<ProductResponseDto>> findAll(@RequestParam(defaultValue = "0") Integer page,
                                                            @RequestParam(defaultValue = "10") Integer size) {
        Page<ProductResponseDto> response = productService.findAll(page, size);
